...
var Game = /** @class */ (function () {
    ...
    //document.getElementById('imageDiv').innerHTML = '<img width="500" height="50" src="img/1.png">';
    
    Game.prototype.startGame = function () {
        //document.getElementById('imageDiv').innerHTML = '<img width="50" height="50" src="img/1.png">';
    ...
    Game.prototype.endGame = function () {
        document.getElementById('imageDiv2').innerHTML = '<img width="50" height="50" src="img/2.png">';
